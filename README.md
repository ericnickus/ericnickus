...
- 🔭 Tightening up on Javascript and node.js applications and React as well.  Worked a lot doing data scraping for a tile website , scraping over half a million products from three major different sites.  Continuing to do websites for customers and projects for a private entrepeneur .  Also completing a project reading .wav files and mixing multiple .wav files and comparing them.  

- :telescope: While I’m working on being a professional blockchain developer and web3 and crypto development, I run my own web developement service. Also consulting on projects that I have expert knowledge in such as RETS projects for Real Estate websites ,and relational database design, integrations and optimization, Data Scraping from major retailer's websites, parsing .wav files and mixing them utilizing ffmpeg and other libraries in node,js with React.js . I also still do create from scratch websites and maintain and fix problems for my smaller customers websites needs and I also handle a pretty good flow of incoming tech work such as fixing problems, wiping hard drives, data recovery, maintenance and upgrading all kinds of laptops and pcs and tablets.  Work is consistent micronotebook.com, decorativestone.com and several others.  Working on a personal website coming soon.  Also completed my own personal mp3 music player showcasing some music ideas I have for my older 2 albums of music material .  Other websites I have coded are at smsold.com gallery and more.  
...
- Data Scraping. Node.js applications, React applications.
- Parsing of metadata in raw .wav files .
